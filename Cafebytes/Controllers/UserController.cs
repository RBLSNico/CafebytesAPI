...
namespace Cafebytes.Controllers
{
    ...
    {
        private readonly CafebytesDbContext db;
        ...
        public UserController(CafebytesDbContext db, IUser user, IAll<User> allController) : base(allController)
        {
            this.db = db;
            this._user = user;
        ...
        //public UserController(CafebytesDbContext db, IAll<User> allController, IStoreProcedures<User> storeProcedures, IAll<User> all, IUser user) : base(allController, storeProcedures, all)
        //{
        //    this.db = db;
        //    _user = user;
        //}
