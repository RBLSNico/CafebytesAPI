...
using CafebytesModels.HostedService;
using CafebytesRepositories;
using CafebytesRepositories.Auth;
...
namespace Cafebytes
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // For Migration
            builder.Services.AddDbContext<CafebytesDbContext>(options => {
            ...
            {
                opt.AddPolicy("CafebytesPolicy", builder =>
                {
